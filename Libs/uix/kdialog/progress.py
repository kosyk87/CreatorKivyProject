...
Альтернативный ProgressBar- https://github.com/Seg-mel/newprogressbar

**Автор:** Musikhin Andrey

**Email:** `melomansegfault@gmail.com <melomansegfault@gmail.com>`_
...
class Progress(BoxLayout):
    ...
    def min(self):
        '''
        The property that sets and returns minimum value.
        type: float;
    ...
    def min(self, value):
        if value < self.line_bar.max:
            ...
            Logger.error('ERROR: min > max! Try again.')

    @property
    def max(self):
        '''
        The property that sets and returns maximum value.
        type: float;
    ...
    def max(self, value):
        if value > self.line_bar.min:
            ...
            Logger.error('ERROR: max < min! Try again.')

    @property
    def bar_value(self):
        '''
        The property that sets and returns progress bar value.
        type: float;
    ...
    def bar_value_percent(self):
        '''
        The property that sets and returns progressbar value in percent.
        type: float;
    ...
    def color(self):
        '''
        The property that sets and returns progress bar color.
        type: str (hex color);
    ...
    def background_color(self):
        '''
        The property that sets and returns progress bar background color.
        type: str (hex color);
    ...
    def border_color(self):
        '''
        The property that sets and returns borders color.
        type: str (hex color);
    ...
    def height_widget(self):
        '''
        The property that sets and returns progressbar value.
        type: int;
    ...
    def padding_widget(self):
        '''
        The property that sets and returns progressbar padding value.
        type: int;
    ...
    def spacing_widget(self):
        '''
        The property that sets and returns spacing value between elements.
        type: int;
    ...
    def add_value_percent(self, value=1):
        ''' 
        Add/subtract percent value to line bar. Not obligatory set min and max.
        value type: float;
